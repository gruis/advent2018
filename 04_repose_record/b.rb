...
class Guard
  ...
  def most_asleep_min
    @most_asleep_min ||= most_asleep[1]
  end

  def most_asleep_cnt
    @most_asleep_cnt ||= most_asleep[0]
  end
...
most_asleep_cnt = guards.values.sort_by(&:most_asleep_cnt).last
puts most_asleep_cnt.inspect

id  = most_asleep_cnt.id
min = most_asleep_cnt.most_asleep_min
puts "#{id} * #{min} = #{id * min}"
